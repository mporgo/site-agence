        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          >
            ...
            <p className="text-xl text-blue-200 mb-8 max-w-2xl mx-auto">
              Rejoignez des milliers de personnes qui ont déjà commencé leur transformation avec Kamdsolution
            </p>
            <motion.button
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-2xl font-bold text-white">Kamdsolution</h3>
        ...
        <div className="border-t border-blue-800/50 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-blue-300 text-sm">
            © 2025 Kamdsolution. Tous droits réservés.
          </p>
