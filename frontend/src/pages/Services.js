  ...
  const services = [
    {
      ...
      price: 'À partir de 5000 FCFA/séance'
    },
    {
      icon: DollarSign,
      ...
      price: 'À partir de 7500 FCFA/séance'
    },
    {
      icon: Briefcase,
      ...
      price: 'À partir de 10000 FCFA/séance'
    },
    {
      icon: GraduationCap,
      ...
      price: 'À partir de 8000 FCFA/séance'
    },
    {
      icon: Sparkles,
      ...
      price: 'À partir de 12000 FCFA/formation'
    },
    {
      icon: ShoppingBag,
      ...
      price: 'À partir de 9000 FCFA/consultation'
    }
  ];
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Découvrez ce que nos clients disent de leur expérience avec Kamdsolution
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                content: 'Grâce au coaching de Kamdsolution, j\'ai développé une confiance en moi qui a transformé ma carrière.',
                rating: 5
              },
              {
                name: 'Michel Kouadio',
