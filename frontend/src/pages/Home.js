  ...
  const testimonials = [
    {
      name: 'Marie Kouassi',
      role: 'Entrepreneure',
      content: 'Grâce à Kamdsolution, j\'ai pu développer mon entreprise et tripler mon chiffre d\'affaires en 6 mois.',
      rating: 5
    },
    {
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <motion.p
              ...
              className="text-base sm:text-lg md:text-2xl text-blue-100 mb-8 max-w-xl sm:max-w-2xl md:max-w-3xl mx-auto leading-relaxed"
            >
              Développez vos compétences, réussissez vos projets et transformez votre vie avec 
              l'accompagnement expert de Kamdsolution
            </motion.p>
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-sm sm:text-lg shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 flex items-center space-x-2"
              >
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-white/10 backdrop-blur-lg border border-white/20 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-sm sm:text-lg hover:bg-white/20 transition-all duration-300 flex items-center space-x-2"
              >
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Découvrez les témoignages de ceux qui ont transformé leur vie avec Kamdsolution
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Rejoignez des milliers de personnes qui ont déjà fait confiance à Kamdsolution pour réussir
            </p>
