...
const Blog = () => {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt: 'L\'histoire inspirante de Marie, qui a transformé son idée en entreprise prospère grâce à l\'accompagnement Kamdsolution.',
